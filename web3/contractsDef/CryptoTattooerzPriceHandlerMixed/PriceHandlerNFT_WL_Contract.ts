...
import * as priceHandlerContractDefMumbai from './mumbai/JarvixPriceHandlerMixedWL-mumbai.json'
...
const priceHandlerContractSlice = createSlice({
  name: 'priceHandlerNFT_WL_Contract',
  initialState,
  reducers: {
...
export const getPriceHandlerContractState = (state: RootState) => state.priceHandlerNFT_WL_Contract

export default priceHandlerContractSlice.reducer

// Contract SINGLETON class
//////////////////////////////////////////////////////////////////////////////////
export class PriceHandlerNFT_WL_Contract extends Contract {
...
//////////////////////////////////////////////////////////////////////////////////
let PRICE_HANDLER_NFT_WL_CONTRACT: PriceHandlerNFT_WL_Contract | undefined

// Contract SINGLETON Instance GETTER
//////////////////////////////////////////////////////////////////////////////////
export const GET_PRICE_HANDLER_NFT_WL_CONTRACT = (jsonRpcProvider: any | null, chainId: string): PriceHandlerNFT_WL_Contract =>
  PRICE_HANDLER_NFT_WL_CONTRACT ?
    PRICE_HANDLER_NFT_WL_CONTRACT :
    (PRICE_HANDLER_NFT_WL_CONTRACT = new PriceHandlerNFT_WL_Contract(jsonRpcProvider, chainId))
