...
const I18N = {
  ...
  fireEventString: 'Write String',
  fireEventAddress: 'Write Address',
  fireEventBool: 'Write Bool',
}
    ...
    <div className='flex flex-col gap-8'>
      ...
      <Boundary labels={[i18n.fireEvents]}>
        <div className='flex gap-4'>
          <Button onClick={() => write('write_string', [false, 'Manual write string on events page'])}>{i18n.fireEventString}</Button>
          <Button onClick={() => write('write_address', [false, address])}>{i18n.fireEventAddress}</Button>
          <Button onClick={() => write('write_bool', [false, false])}>{i18n.fireEventBool}</Button>
        </div>
      </Boundary>
